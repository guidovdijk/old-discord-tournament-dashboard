<template>
    <div class="tournament-item-players">
        <div>
            <div
                :class="['tournament-player', 'tournament-player1', getPlayerClass(bracketNode.player1)]"
            ...
            <div
                :class="['tournament-player', 'tournament-player2', getPlayerClass(bracketNode.player2)]"
